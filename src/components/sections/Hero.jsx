...
export default function Hero() {
  return (
    <section className="relative w-full min-h-[calc(100vh-230px)] flex items-center pt-10 lg:pt-0 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col justify-center h-full mt-10 md:mt-0">
        <div className="max-w-3xl animate-in slide-in-from-bottom-8 duration-700 fade-in">
          ...
          {/* Main Heading */}
          <h1 className="text-5xl md:text-6xl lg:text-[3rem] font-bold leading-[1.1] tracking-tight mb-8">
          ...
          {/* Intro Paragraph */}
          <p className="text-gray-800 text-lg md:text-lg md:leading-relaxed mb-10 max-w-2xl font-medium">
