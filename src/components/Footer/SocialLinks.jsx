...
export default function SocialLinks() {
  return (
    <div className="flex flex-col gap-3">
      <h4 className="font-semibold text-[#8ec63f] text-sm mb-1 uppercase tracking-wider">Follow Us</h4>
        ...
        {socialsData.map((social, index) => {
          ...
          return (
            <a
              ...
              rel="noreferrer"
              className="w-8 h-8 flex items-center justify-center rounded-full bg-transparent border border-white/30 text-white hover:bg-brand-orange hover:border-brand-orange hover:text-white transition-colors"
